/**
 * TivoliHeritagePalacePage Component
 * Displays detailed information about Tivoli Heritage Palace-Rewari
 * Changes:
 ...
 * - Updated page title to "Tivoli Heritage Palace-Rewari"
 * - Updated gallery images to use Heritage Palace specific images
 * - Modified the experiences section with heritage-focused content
 * - Updated map iframe to point to Heritage Palace location
 ...
 * - Updated address to "Kanhawas, 5PF3+53X Kanhawas, Haryana, Rewari, Haryana 123401, India"
 * - Fixed missing closing span tag in culinary highlights section
 */
...
const galleryImages = [
  ...
  'https://pbkxpylwatscfjzbmwur.supabase.co/storage/v1/object/public/homepage_image//banquet.jpg',
  'https://oawudxprjjgsdtsvroqt.supabase.co/storage/v1/object/public/tivoliheritagerewari//mainpagephoto5.jpg'
];
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12 pt-16 md:pt-20 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ...
          <div className="relative h-[400px] md:h-[500px] rounded-lg overflow-hidden">
            <img
              src="https://oawudxprjjgsdtsvroqt.supabase.co/storage/v1/object/public/tivoliheritagerewari//mainpagephoto5.jpg"
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-0 space-y-4">
            <h1 className="font-serif text-3xl md:text-4xl text-neutral-800 mb-2">Tivoli Heritage Palace-Rewari</h1>
...
src="https://oawudxprjjgsdtsvroqt.supabase.co/storage/v1/object/public/tivoliheritagerewari//standard%20room.jpg"
        ...
        {/* Wedding at Tivoli Heritage Palace */}
        <section className="py-6 md:py-12 bg-white">
          <div className="container mx-auto px-4 md:px-8 lg:px-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
                <img
                  src={hotel.images[0]}
                  alt="Tivoli Heritage Palace Wedding Venue"
                  className="w-full h-full object-cover"
                />
                ...
                <div className="p-6">
                  <ul className="space-y-3 text-neutral-600">
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-[#CD9F59] rounded-full mr-3"></span>
            ...
            <div className="max-w-5xl mx-auto px-4 md:px-8 lg:px-0">
              ...
              <div className="space-y-6">
                ...
                <div className="w-full h-[400px] rounded-xl overflow-hidden shadow-lg">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3516.4514419371176!2d77.30918827548489!3d28.19359377590727!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cd1fe467c304b%3A0x5d9583931a50cb3e!2sTivoli%20Royal%20Palace!5e0!3m2!1sen!2sin!4v1744945233833!5m2!1sen!2sin"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
