...
const venues = [
  // TIVOLI Properties
  {
    ...
    name: 'The Tivoli',
    location: 'Delhi',
    image: 'https://pbkxpylwatscfjzbmwur.supabase.co/storage/v1/object/public/homepage_image//maingate_thetivoli.jpg',
    brand: 'tivoli'
  },
  {
    ...
    image: 'https://pbkxpylwatscfjzbmwur.supabase.co/storage/v1/object/public/homepage_image//thumbnail-royalpalace-hp.jpg',
    brand: 'tivoli'
  },
  {
              ...
              <div key={venue.id} className="group cursor-pointer">
                <div className="relative overflow-hidden mb-2 md:mb-3 rounded-lg shadow-lg aspect-[4/5]">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    {venue.id === 'tivoli-riviera-palace' ? (
                      <a 
                        href="https://zp1v56uxy8rdx5ypatb0ockcb9tr6a-oci3--5173--fb22cd3d.local-credentialless.webcontainer-api.io/delhi/tivoli-bijwasan"
                        className="px-6 py-2 bg-white/95 text-neutral-900 text-sm uppercase tracking-wider hover:bg-white transition-colors rounded-lg"
                      >
                        Explore
                      </a>
                    ) : (
                      <Link 
                        to={venue.id === 'o1' ? '/delhi/omnia-dwarka-expressway' : `/${venue.location.toLowerCase()}/${venue.id}`}
                        className="px-6 py-2 bg-white/95 text-neutral-900 text-sm uppercase tracking-wider hover:bg-white transition-colors rounded-lg"
                      >
                        Explore
                      </Link>
                ...
                {venue.id === 'tivoli-riviera-palace' ? (
                  ...
                  <Link to={venue.id === 'o1' ? '/delhi/omnia-dwarka-expressway' : `/${venue.location.toLowerCase()}/${venue.id}`}>
                  <h3 className="font-serif text-lg md:text-xl text-neutral-800 mb-1 group-hover:text-[#CD9F59] transition-colors">
                    {venue.name}
                  </h3>
                  </Link>
